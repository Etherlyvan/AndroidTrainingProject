package com.example.latian2.model
...
class AuthViewModel : ViewModel() {
    ...
    private val database: FirebaseDatabase = FirebaseDatabase.getInstance("https://apptodolistprojec-default-rtdb.asia-southeast1.firebasedatabase.app/")
